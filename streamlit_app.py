...
st.header("📊 Estatísticas do Time B") finalizacoes_b = st.number_input("Finalizações Time B", min_value=0) chutes_alvo_b = st.number_input("Chutes no Alvo Time B", min_value=0) xg_b = st.number_input("xG Time B", min_value=0.0) ataques_perigosos_b = st.number_input("Ataques Perigosos Time B", min_value=0) posse_b = 100 - posse_a
